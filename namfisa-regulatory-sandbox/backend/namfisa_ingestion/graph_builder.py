...
class GraphBuilder:
    ...
    def _extract_companies(self, text: str) -> List[str]:
        ...
        tech_companies = {
            "Buffr Inc.", "Insait.io", "Polar Power Inc.",
            "Brandeis International Business School", "Namibia University of Science and Technology",
            "Standard Bank", "Old Mutual", "EY", "PwC", "Deloitte", "KPMG"
        }
